...
export default function ManagePropertiesPage() {
    const [allProperties, setAllProperties] = useState<Property[]>([]); // Stores all properties
    const [properties, setProperties] = useState<Property[]>([]); // Stores properties for the current page
    ...
    // Fetch all properties from the server once
    const fetchAllProperties = useCallback(async () => {
        setLoading(true);
        setError(null);
        try {
            // Updated API call to fetch all properties without pagination params
    ...
    // Effect to fetch all properties on initial load
    useEffect(() => {
        fetchAllProperties();
    }, [fetchAllProperties]);

    // Effect to handle filtering, searching, and pagination on the frontend
    useEffect(() => {
        ...
        // Calculate total pages and slice the properties for the current page
    ...
    const executeDelete = async () => {
        ...
        try {
            ...
            // Update the state of allProperties directly
