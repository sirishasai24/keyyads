...
export default function EditPropertyPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            setLoading(true);
            try {
                // Fetch property details from the admin-specific route
                const propertyRes = await axios.get(`/api/admin/manage-properties/edit/${propertyId}`);
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.put(
                `/api/admin/manage-properties/edit/${propertyId}`, // Admin-specific PUT route
                formData,
                {
                    headers: {
            ...
            router.push("/admin/manage-properties"); // Redirect to the admin properties dashboard
        } catch (err) {
    ...
    return (
        <div className="container mx-auto p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-[calc(100vh-80px)] font-sans">
            ...
            <p className="text-lg text-gray-600 mb-10 text-center max-w-3xl mx-auto">
                Update the details of this property. All changes will be reflected live.
            </p>
                ...
                <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md border border-gray-100 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center">
                        <input
                            ...
                            onChange={handleChange}
                            className={`h-5 w-5 rounded border-gray-300 focus:ring-[#2180d3] cursor-pointer text-[#20b4b1]`}
                        />
